...
If ($x == "group_story_links_publish") {
		...
		If ($x == "group_story_links_queued") {
			return my_pligg_base."/join_group.php?action=private&amp;link=" . $var1;
			}

	


		If ($x == "group_story_links_discard") {
			return my_pligg_base."/join_group.php?action=discard&amp;link=" . $var1;
			}
...
//		If ($x == "storycattitle") {return my_pligg_base."/category/" . $var1 . "/" . $var2 ."/";}
		...
		If ($x == "group_story_links_publish") {return my_pligg_base."/join_group/action/queued/link/" . $var1 . "/";}
		If ($x == "group_story_links_queued") {return my_pligg_base."/join_group/action/private/link/" . $var1 . "/";}
