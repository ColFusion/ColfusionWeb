                        ...
                        <table class="relProfile">
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td data-bind="text: description() || 'empty'" class="profileContent">This description is long enough. This description is long enough. This description is long enough.</td>
                                </tr>
                            </tbody>
                        </table>
                    </div>
                    ...
                    <a data-bind="click: $root.loadLinkData.bind($data, $data)">
                        <table class="link">
                            <tr>
                                ...
                                <td data-bind="text: toLinkPart.transInput" class="toPart linkPart linkPartText"></td>
                            </tr>
                        </table>
                    </a>
                </li>
        ...
        <div data-bind="visible: currentLink() && !isLoadingData()" id="dataTableWrapper">
            ...
            <div class="accordionWrapper">
                <div class="accordion" id="diffDataAccordion">
                    <div class="accordion-group">
                        <div class="accordion-heading">
                            <a class="accordion-toggle" data-toggle="collapse" data-parent="#diffDataAccordion" href="#diffDataCollapse">Table of Different Values
                            </a>
                        </div>
                            ...
                            <div class="accordion-inner">
                                <div>
                                    ...
                                    <span style="float: right;">
                                        <input data-bind="checked: isDistinctTablesShown" type="checkbox" style="margin: 0 5px 0 0;" /><span>Show all distinct values</span></span>
                                </div>
            ...
            <div class="accordionWrapper" style="display: none;">
                <div class="accordion" id="sameDataAccordion">
                    <div class="accordion-group">
                        <div class="accordion-heading">
                            <a class="accordion-toggle" data-toggle="collapse" data-parent="#sameDataAccordion" href="#sameDataCollapse">Table of Same Values
                            </a>
                        </div>
