...
var onlineUsers = {
	...
	init : function(){
		...
		$('#submitButton').click(function(){
			...
			$.ajax({
		        url: base+'chat/chatController.php?action=submitChat&details='+params.text+'&room='+room, 
	...
	getChats : function(callback){
		$.ajax({
	        url: base+'chat/chatController.php?action=getChats&lastID='+onlineUsers.data.lastID+'&room='+room, 
	        type: 'get',
	        dataType: 'json',
	        success: function (data) {
	...
	getUsers : function(callback){
		$.ajax({
	        url: base+'chat/chatController.php?action=getAllOnlineUsers&room='+room, 
	        type: 'get',
	        dataType: 'json',
	        success: function (data) {
	            var users = [];
