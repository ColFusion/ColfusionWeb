...
<div id="submit">
	<div id="submit_step_1_content">
		...
		<div class="submit_step_1_left">
			...
			<label>{#PLIGG_Visual_Submit2_Title#}: </label><br/>{#PLIGG_Visual_Submit2_TitleInstruct#}<br/>
		...
		<div class="submit_right_sidebar" id="dockcontent">
			...
			<input class="button_max" type="submit" value="{#PLIGG_Visual_Submit2_Continue#}" onclick="display_alert()"/>
